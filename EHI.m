...
wordActivity = {'WRITING','DRAWING','THROWING','USING SCISSORS',...
            'USING A TOOTHBRUSH', 'USING A KNIFE (WITHOUT FORK)', 'USING A SPOON',...
            'USING A BROOM (UPPER HAND)', 'STRIKING A MATCH', 'OPENING A BOX (LID)', ...
...
filesave = sprintf('EHI_full_%i_s%i.mat',numParticipant,numSession);
